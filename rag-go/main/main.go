...
func main() {
	...
	docPipe := pipeline.NewDoc(qdrantClient, vllmClient, embedClient, embedClient, cfg.RerankEnabled, cfg.RerankOverfetchMultiplier, cfg.ContextTruncationEnabled, cfg.ChangeCollection, cfg.CodeCollection, cfg.DocCollection, cfg.AppProfileDir, cfg.AppProfileFiles).WithLogger(log.Logger)
